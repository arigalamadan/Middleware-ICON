...
def serverStatus(eu-middleware-sb1:7004, 7004, weblogic, weblogic1):
    serverstat = '############          ' + url + '          #############\n'
    portArr=ports.split(',')
    for port in portArr:
        try:	
            connect(weblogic, weblogic, 't3://'+eu-middleware-sb1:7004+': '+7004)
...
result=''
# result = result + serverStatus(sys.argv[1],sys.argv[2],sys.argv[3],sys.argv[4],sys.argv[5])i
